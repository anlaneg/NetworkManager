...
GBytes *nm_utils_dhcp_client_id_systemd_node_specific_full (const guint8 *interface_id,
                                                            gsize interface_id_len,
                                                            const guint8 *machine_id,
                                                            gsize machine_id_len);

GBytes *nm_utils_dhcp_client_id_systemd_node_specific (const char *ifname);
